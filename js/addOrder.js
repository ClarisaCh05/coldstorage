...
import { fetchClient, fetchDriver, fetchKendaraan, fetchGedung } from "./fetch/addOrder.js";
...
document.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        addItems.addEventListener("click", async (e) => {
            ...
            //     const selectedGedungId = gedung.value;
            ...
            if(selectedService === "Door to Door") {
                for(const x of pallet) {
                    ...
                    if(x.Id == aisle){
                        console.log("Kapasitas:", x.Kapasitas)
                        console.log("Berat:", beratInput.value)
        ...
        submitAllFormBtn.addEventListener("click", async () => {
            try {
                ...
                const rentDriver = orderData.map(item => item.Rent_Driver);
                const rentDriverString = rentDriver.join(',')
                console.log(rentDriverString)
